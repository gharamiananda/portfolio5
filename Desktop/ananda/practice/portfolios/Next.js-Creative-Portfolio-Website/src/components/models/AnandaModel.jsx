...
Command: npx gltfjsx@6.2.16 public/models/ananda.glb 
*/

import { useGLTF } from '@react-three/drei'

export function AnandaModel(props) {
  const { nodes, materials } = useGLTF('models/ananda.glb')
  return (
...
useGLTF.preload('models/ananda.glb')